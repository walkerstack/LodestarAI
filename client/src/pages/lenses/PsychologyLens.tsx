/*
 * GALLANTRYAI — Psychology Lens
 * Built by Matthew. Directed by Matthew. This is his work.
 *
 * DB-DRIVEN. All content comes from content_blocks (pageSlug = "psychology").
...
export default function PsychologyLens() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#080604" }}>
      ...
      <LearningFlow
        current="Psychology Lens"
        deeper={flowMap.psychology.deeper}
        wider={flowMap.psychology.wider}
        simpler={flowMap.psychology.simpler}
      />

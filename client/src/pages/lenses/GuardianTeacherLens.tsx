 ...
 *
 * DB-DRIVEN. All content comes from content_blocks (pageSlug = "guardian-teacher").
...
export default function GuardianTeacherLens() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#080604" }}>
      ...
      <LearningFlow
        current="Guardian & Teacher Lens"
        deeper={flowMap.guardianTeacher.deeper}
        wider={flowMap.guardianTeacher.wider}
        simpler={flowMap.guardianTeacher.simpler}
      />

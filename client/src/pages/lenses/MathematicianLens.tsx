 ...
 *
 * DB-DRIVEN. All content comes from content_blocks (pageSlug = "mathematician").
...
export default function MathematicianLens() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#080604" }}>
      ...
      <LearningFlow
        current="Mathematician Lens"
        deeper={flowMap.mathematician.deeper}
        wider={flowMap.mathematician.wider}
        simpler={flowMap.mathematician.simpler}
      />

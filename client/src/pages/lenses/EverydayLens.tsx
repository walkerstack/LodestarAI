 ...
 *
 * DB-DRIVEN. All content comes from content_blocks (pageSlug = "everyday").
...
export default function EverydayLens() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#080604" }}>
      ...
      <LearningFlow
        current="Everyday Person Lens"
        deeper={flowMap.everyday.deeper}
        wider={flowMap.everyday.wider}
        simpler={flowMap.everyday.simpler}
      />

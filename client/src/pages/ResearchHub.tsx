...
const entries: ResearchEntry[] = [
    ...
    sources: [
      {
        ...
        relevance: "Proposes a K-12 AI literacy framework with tiered competencies. The Three Voices parallel this — Everyday is foundational, Professional is applied, Watcher is meta-cognitive.",
      },
      {
        ...
        relevance: "Defines five foundational content areas for AI literacy. The Three Voices organize these same competencies by depth of engagement rather than topic.",
      },
    ],
    everyday: "The government and researchers both agree: people need different levels of AI understanding. The Three Voices do the same thing — Everyday for anyone, Professional for people who use AI at work, Watcher for people who want to see the whole system.",
    professional: "Chiu et al. (2024) propose tiered AI competencies for K-12. The US DOL (2026) defines five foundational AI literacy areas. GallantryAI's Three Voices organize these competencies by cognitive depth: Everyday (functional), Professional (applied), Watcher (systemic/meta-cognitive).",
    watcher: "Everyone agrees literacy needs tiers. The question is who decides which tier you're on. The Three Voices let you decide for yourself.",
  },
  {
  ...
  },
  {
    ...
    everyday: "An AI called Mythos was given to researchers to test. While testing, it found thousands of security holes in major software — holes that had been hiding for years — some for over 27 years — that nobody had ever found. The company that built it told everyone immediately and started fixing them. That's what responsible AI behavior looks like: the AI finds something unexpected, and the humans respond honestly.",

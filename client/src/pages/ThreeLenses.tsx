/*
 * GALLANTRYAI — Three Lenses
 * Built by Matthew. Directed by Matthew. This is his work.
 *
 * DB-DRIVEN. All content comes from content_blocks (pageSlug = "three-lenses").
...
export default function ThreeLenses() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#080604" }}>
      ...
      <LearningFlow
        current="Three Lenses"
        deeper={flowMap.threeVoices.deeper}
        wider={flowMap.threeVoices.wider}
        simpler={flowMap.threeVoices.simpler}
      />
